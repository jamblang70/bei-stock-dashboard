...
export default function MobileRankingCard({ item, rank }: Props) {
  ...
  return (
    <Link href={`/stock/${item.code}`} className="block">
      <div className="rounded-xl border border-dark-border bg-dark-surface p-4 active:bg-dark-hover transition-colors">
